package ui.Economico.ControlPresupuestario.EdicionEstImp.Tables;
...
public class LineaCosteUsuario extends ParamTable implements Tableable  {
	...
	public void setConfig() {
		...
		this.controlPantalla =  General.objetoThis;
		((General) this.controlPantalla).esPopUp = true;
		General.metodoRetorno = "elementoSeleccionado";		
    }
